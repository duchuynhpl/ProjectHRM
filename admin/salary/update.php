...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "UPDATE test_table SET trangthai ='$trangthai' WHERE tenban ='$tenban'";
        $query = mysqli_query($con, $sql);
        if($query){
            echo '<script language="javascript">
...
<body>
    <div class="sidebar">
        ...
        <ul class="nav_list">
            ...
            <li>
                <a href="/admin/table/index.php" class="active">
                     ...
                     <div class="col-sm-8 offset-sm-2">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="text-center">Cập nhật trạng thái bàn</h3>
                            </div>
                            <div class="card-body">   
                                <form method='POST' action="">
                                    <div class="form-group row">
                                    <label class="col-sm-5 col-form-label" for="work">Tên bàn</label>
                                        <div class="col-sm-7">
                                            <select name="tenban" id="" class="form-control">
                                                <?php $sql = "SELECT * FROM test_table";
                                                $tableList = executeResult($sql);
                                                foreach($tableList as $table){
                                                echo'<option value="'.$table['tenban'].'">'.$table['tenban'].'</option>';} ?>
                                            </select>
                                        </div>
                                    </div>
