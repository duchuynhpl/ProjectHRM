...
<body>
    ...
    <div class="home_content">
        <div class="text" style="font-weight: bold;">Tổng quát</div>
            <div class="center">
            <section class="dashboard">
                        <div class="table">
                            ...
                            <div class="sp kh">
                                ...
                                echo '<span>' . mysqli_num_rows($result) . '</span>';
                                ?>
                                <p><a href="groups/">xem chi tiết➜</a></p>
                            </div>
                            <div class="sp dm">
                                <p>Bảng lương Excel</p>
                                <p><a href="#">Đang phát triển➜</a></p>
                            </div>

                            <div class="sp dm">
                                <p>Bảng công tác Excel</p>
                                <p><a href="#">Đang phát triển➜</a></p>
                            </div>
                        </div>
                    </section>
                    ...
                    <div class="general">
                        ...
                        <div class="trip">
                            ...
                            <ui class="pagination">
                                ...
                                if (mysqli_num_rows($query)) {
                                    $numrow = mysqli_num_rows($query);
                                    $current_page = ceil($numrow / 2);
                                }
                                for ($i = 1; $i <= $current_page; $i++) {
                                    // Nếu là trang hiện tại thì hiển thị thẻ span
                                    // ngược lại hiển thị thẻ a
                                    if ($i == $current_page) {
                                        echo '<li class="page-item"><a class="page-link" href="?page1=' . $i . '">' . $i . '</a></li>';
                                    } else {
                                        echo '<li class="page-item"><a class="page-link" href="?page1=' . $i . '">' . $i . '</a></li>';
                                    }
                                }
